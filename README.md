...
#> $ r_internationally                 <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
...
#> $ highlight                         <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
...
#> $ highlights                        <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ resources                         <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ new_packages                      <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ videos_and_podcasts               <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ tutorials                         <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ r_project_updates                 <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ upcoming_events_in_3_months       <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ call_for_participation            <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ quotes_of_the_week                <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ r_in_organizations                <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
...
#> $ r_in_academia                     <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ rtistry                           <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ insights                          <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ r_in_the_real_world               <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ updated_packages                  <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ shiny_apps                        <list> <NULL>, <NULL>, <NULL>, <NULL>, <NU…
#> $ jobs                              <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, …
